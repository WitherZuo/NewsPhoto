...
[![Open in GitHub Codespaces](https://img.shields.io/badge/_-Open%20in%20GitHub%20Codespaces-%2324292e?style=for-the-badge&logo=github&logoColor=%23ffffff&labelColor=%232f363d&color=%2324292e)](https://codespaces.new/WitherZuo/NewsPhoto?devcontainer_path=.devcontainer%2Frootful%2Fdevcontainer.json)
...
> **对 Windows 用户：**
>
> 为了显著减小生成的 .exe 文件体积，建议配合 UPX (Ultimate Packer for eXecutables) 使用。PyInstaller 会自动识别系统路径中的 UPX 引擎。
>
> 1. 请前往 [UPX 官网](https://github.com/upx/upx/releases/latest) 下载适配您架构的压缩包；
> 2. 解压后，将 upx.exe 所在的目录添加到系统环境变量 PATH 中；
> 3. 再次打包时，PyInstaller 将自动执行压缩。
